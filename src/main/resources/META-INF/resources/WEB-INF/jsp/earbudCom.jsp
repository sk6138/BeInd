    ...
    <div class="container compare-card my-5 mb-5">
      ...
      <c:forEach items="${Aearbuds}" var="Aearbuds2"> 
              <c:forEach items="${Fearbuds}" var="Fearbuds2"> 
                <div>
                    <p class="fs-4 fw-bold">${Fearbuds2.modelName}</p>
                </div>
                <div class="">
                    <table class=" table-logo">
                        <tr>
                            ...
                            <td>
                                ...
                                <c:if test="${empty Aearbuds2.price}">
                                     not available
                                   </c:if>
                                   <c:if test="${not empty Aearbuds2.price}">
                                     &#8377;   ${Aearbuds2.price}
                                   </c:if>
                              </p>
                            </td>
                            <td><a href="${Aearbuds2.link}"><button class=" compare-card-button bg-dark text-light" >GO TO STORE ></button></a></td>
                        </tr>
                        <tr>
                            <td><img src="/image/a2.jpeg" alt="" class="compare-card-logo"></td>
                            <td>
                                <p class="compare-card-price">
                                 <c:if test="${empty Fearbuds2.price}">
                                     not available
                                   </c:if>
                                   <c:if test="${not empty Fearbuds2.price}">
                                     &#8377;   ${Fearbuds2.price}
                                   </c:if>
                                
                                </p>
                            </td>
                            <td><a href="${Fearbuds2.link}"><button class="compare-card-button bg-dark text-light" >GO TO STORE ></button></a></td>
                        </tr>
                    </table>
                </div>
                <div class="my-4 ">
                    ...
                    <tr>
                        <td><img class="card-icon" src="image/processor.png" alt=""><span>${Fearbuds2.withmic}</span></td>
                        
                    </tr>
                    <tr>
                        <td><img class="card-icon" src="image/display-size.png" alt=""><span>${Fearbuds2.dynamicdriver}</span></td>
                        
                    </tr>
                    <tr>
                        <td><img class="card-icon" src="image/rear-camera.png" alt=""><span>${Fearbuds2.gamingmode}</span></td>
                       
                    </tr>
                    <tr>
                        <td><img class="card-icon" src="image/lighting.png" alt=""><span>${Fearbuds2.voiceassistance}</span></td>
