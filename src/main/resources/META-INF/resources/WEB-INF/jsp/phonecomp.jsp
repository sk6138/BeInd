            ...
            <div class="compare-card-divider">
                    ...
                    <table class=" table-logo">
                        <tr>
                            ...
                            <td>
                                ...
                                <c:if test="${empty all2.price}">
                                     not available
                                   </c:if>
                                   <c:if test="${not empty all2.price}">
                                     &#8377;   ${all2.price}
                                   </c:if>
                                </p>
                            </td>
                            <td><a href="${all2.link}"><button class=" compare-card-button bg-dark text-light" >GO TO STORE ></button></a></td>
                        </tr>
                        <tr>
                            <td><img src="image/a2.jpeg" alt="" class="compare-card-logo"></td>
                            <td>
                                <p class="compare-card-price">
                                                                <c:if test="${empty all.price}">
                                     not available
                                   </c:if>
                                   <c:if test="${not empty all.price}">
                                     &#8377;   ${all.price}
                                   </c:if>
                                </p>
                            </td>
                ...
                <div class="my-4 ">
                    ...
                    <tr>
                        ...
                        <td><img class="card-icon" src="image/ram.png" alt=""><span>${all.ram} ${all.rom}</span></td>
                    </tr>
                    <tr>
                        <td><img class="card-icon" src="image/display-size.png" alt=""><span>${all.display}</span></td>
                        <td><img class="card-icon" src="image/sim.png" alt=""><span>${all.sim}</span></td>
                    </tr>
                    <tr>
                        <td><img class="card-icon" src="image/rear-camera.png" alt=""><span>${all.camera}</span></td>
                        <td><img class="card-icon" src="image/front-camera.png" alt=""><span>${all.networktype}</span></td>
                    </tr>
                    <tr>
