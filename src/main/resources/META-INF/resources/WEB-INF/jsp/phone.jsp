 ...
 <div class="container ">
    <div class="row  ">
            ...
            <div class="card" style="width: 18rem;">
                ...
                <img src="data:image/jpeg;base64,${phones.img}" class="card-img-top" alt="..."> 
			  ...
			  <c:forEach items="${phone2}" var="phones2"> 
				...
				<a href="/${phones2.modelName}/${phones2.ram}/${phones2.rom}" >
				 <div class="col coll">
            <div class="card" style="width: 18rem;">
             
                <img src="data:image/jpeg;base64,${phones2.img}" class="card-img-top" alt="..."> 
                <div class="card-body">
