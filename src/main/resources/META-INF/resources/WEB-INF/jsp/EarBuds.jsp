...
<h1>Home Appliances list</h1>
    ...
    <div class="row  ">
			 ...
			 <c:forEach items="${home}" var="earbuds">
				
				 <div class="col coll">
            <div class="card" style="width: 18rem;">
                <img src="image/category-earbuds.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title"> ${earbuds.model}  </h5>

                </div>
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">${earbuds.col3}</li>
                    <li class="list-group-item">${earbuds.col2}</li>
                    <li class="list-group-item">${earbuds.col4} </li>
                    <li class="list-group-item">${earbuds.col6} </li>
                    <li class="list-group-item">${earbuds.col7} </li>
                </ul>
